...
public class Order {
    ...
    public Order(String str_Order,String str_customer, int i_money, int i_status) {
    ...
    public Order(String i_table,int i_money,String str_Order,int i_status){
        this.str_Order = str_Order;
    ...
    public ArrayList<ArrayList<OrderItems>> getOrderItems() {
        return orderItems;
    }
